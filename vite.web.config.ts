...
export default defineConfig({
  ...
  build: { outDir: resolve("dist-web"), emptyOutDir: true, chunkSizeWarningLimit: 500, modulePreload: false, rollupOptions: { output: { manualChunks(id) { if (id.includes("pdf-lib")) return "vendor-pdf"; if (id.includes("jszip")) return "vendor-zip"; if (id.includes("packages/core/src")) return "tool-processors"; if (id.includes("packages/legacy/src")) return "legacy-tools"; return undefined; } } } }
});
