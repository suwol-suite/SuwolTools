...
export default defineConfig({
  ...
  renderer: {
    ...
    build: { outDir: resolve("dist-renderer"), chunkSizeWarningLimit: 500, modulePreload: false, rollupOptions: { input: resolve("apps/desktop/src/renderer/index.html"), output: { manualChunks(id) { if (id.includes("pdf-lib")) return "vendor-pdf"; if (id.includes("jszip")) return "vendor-zip"; if (id.includes("packages/core/src")) return "tool-processors"; if (id.includes("SuwolWebTools/src")) return "legacy-tools"; return undefined; } } } }
  }
});
